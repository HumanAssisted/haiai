...
type EmailMessage struct {
	...
	SenderMailAuthPassed  bool                   `json:"sender_mail_auth_passed"`
	SenderMailAuthMethod  *string                `json:"sender_mail_auth_method,omitempty"`
	SenderMailAuthDetails map[string]interface{} `json:"sender_mail_auth_details,omitempty"`
